...
Структура реляционной базы включает пять основных таблиц, отражающих ключевые предметные сущности и инфраструктурные потребности платформы. Связи между ними показаны на рисунке 3, перечень таблиц и их назначения приведён в таблице 3.

![ER-диаграмма основных сущностей реляционной базы](../assets/diagrams/er-diagram.png)

Рисунок 3 – ER-диаграмма основных сущностей реляционной базы платформы model-forge
